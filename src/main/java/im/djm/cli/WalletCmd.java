...
class WalletCmd implements Cmd {
	...
	public void sendMultiCoins(Map<String, Wallet> wallets, String[] cmdLine) {
	...
	public void sendCoin(Map<String, Wallet> wallets, String[] cmdLine) {
		if (cmdLine.length != 4) {
	...
	public void deleteWallet(Map<String, Wallet> wallets, String[] cmdLine) {
		if (cmdLine.length != 2) {
	...
	public void walletStatus(Map<String, Wallet> wallets, String[] cmdLine) {
		if (cmdLine.length != 2) {
	...
	public void listAllWallets(Map<String, Wallet> wallets) {
	...
	public void createMultiNewWallets(BlockChainNode blockChainNode, Map<String, Wallet> wallets, String[] cmdLine) {
		if (cmdLine.length < 2) {
	...
	public void createNewWallet(BlockChainNode blockChainNode, Map<String, Wallet> wallets, String[] cmdLine) {
		if (cmdLine.length != 2) {
			printMessages("Wrong command format.", HelpCommand.cmdHelpExample.get(CmdConstants.CMD_WNEW));
			return;
		}
	...
	private Wallet creatWalletWithName(BlockChainNode blockChainNode, Map<String, Wallet> wallets, String walletName) {
		if (wallets.containsKey(walletName)) {
